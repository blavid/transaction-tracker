const componentSpec = {
    async run({ steps, $ }) {
        ...
        const PAYEES = [
            ...
            { r:/HILLSBORO\s+UTILITIES/i,          n:'City Of Hillsboro',       c:'Utilities - H',       b:false, s:true,  d:'Water and sewer service' },
            ...
            { r:/STARLINK\s+HAS/i,                 n:'Starlink',                c:'Utilities- H',        b:false, s:true,  d:'Monthly Starlink subscription' },
